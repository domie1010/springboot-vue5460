<template>
	<view :style='{"minHeight":"100vh","padding":"24rpx","flexWrap":"wrap","background":"#f0f8fa","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<view class="title" :style='{"margin":"0","color":"#333","borderRadius":"0","textAlign":"center","background":"#ffffff","width":"100%","lineHeight":"80rpx","fontSize":"32rpx"}'>{{detail.title}}</view>
		...
		<view :style='{"padding":"0 20rpx 32rpx 0","alignItems":"center","borderRadius":"0","background":"#fff","display":"flex","width":"40%","justifyContent":"space-between","order":"8"}'>
		...
		<div :style='{"padding":"0 24rpx 32rpx 24rpx","alignItems":"center","borderRadius":"0","background":"#ffffff","display":"flex","width":"60%","justifyContent":"space-between","height":"auto"}'>
		...
		<!-- 热门 -->
		<view class="hot" :style='{"padding":"0","margin":"20rpx 0","borderRadius":"0","background":"#fff","width":"100%","height":"auto","order":"11"}'>
		  <view :style='{"padding":"0 24rpx","borderColor":"#ffcc00","margin":"0","color":"#333","textAlign":"center","background":"#fdf6ec","borderWidth":"6rpx 0 0","width":"100%","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid","fontWeight":"600","height":"auto"}'>热门信息</view>
		  <view :style='{"padding":"40rpx 0px 0","margin":"0","borderRadius":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in hotList" :key="index" :style='{"border":"0px solid #eee","padding":"0 24rpx","margin":"0 0 40rpx","borderRadius":"12rpx","background":"none","width":"100%","height":"auto"}' @click="toDetail(item.id)">
			  <image :style='{"width":"45%","objectFit":"cover","borderRadius":"8rpx","float":"left","display":"block","height":"160rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
		      <view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","whiteSpace":"nowrap","color":"#333","textAlign":"left","width":"55%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","float":"right"}'>{{ item.title }}</view>
		      <view :style='{"padding":"0 20rpx","color":"#999","textAlign":"left","width":"55%","lineHeight":"48rpx","fontSize":"28rpx","float":"right"}'>{{ item.addtime }}</view>
		    </view>
		  </view>
		</view>
		<!-- 推荐 -->
