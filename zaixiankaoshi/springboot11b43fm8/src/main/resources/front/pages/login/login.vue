<template>
	<view class="content">
		<view class="box" :style='{"minHeight":"100vh","padding":"40rpx 48rpx 24rpx","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240223/4f2e290ac4ba46119c72ae333fa42924.jpg) no-repeat center top / 100% 100%,#f0f8fa","display":"flex","width":"100%","height":"auto"}'>
			<view :style='{"minHeight":"50vh","padding":"80rpx 80rpx 24rpx 48rpx","margin":"40rpx 0 0px","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240223/4eb1d7930ba64f0eafaf830376d3b774.png) no-repeat center top / 100% 100%","flexDirection":"column","display":"flex","width":"100%","position":"relative","justifyContent":"center","height":"auto"}'>
				...
				<view v-if="loginType==1" :style='{"margin":"0 0 40rpx 0","borderColor":"#eee","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="uni-form-item uni-column">
					<view :style='{"color":"#eaa602","textAlign":"left","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","minWidth":"160rpx","fontWeight":"500"}' class="label">账号：</view>
				...
				<view v-if="loginType==1" :style='{"margin":"0 0 40rpx 0","borderColor":"#eee","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="uni-form-item uni-column">
					<view :style='{"color":"#eaa602","textAlign":"left","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","minWidth":"160rpx","fontWeight":"500"}' class="label">密码：</view>
				...
				<view v-if="roleNum>1" :style='{"margin":"0 0 20rpx 0","borderColor":"#eee","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"76rpx"}'>
					<view :style='{"color":"#eaa602","textAlign":"left","width":"auto","lineHeight":"48rpx","fontSize":"28rpx","minWidth":"160rpx","fontWeight":"500"}' class="label">用户类型：</view>
				...
				<button v-if="loginType==1" class="btn-submit" @tap="onLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"40rpx auto 40rpx","color":"#fff","borderRadius":"16rpx","background":"#ffcc00","width":"50%","lineHeight":"88rpx","fontSize":"30rpx","fontWeight":"600","height":"88rpx","order":"2"}'>登录</button>
				<button v-if="loginType==2" class="btn-submit" @tap="onFaceLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"40rpx auto 40rpx","color":"#fff","borderRadius":"16rpx","background":"#ffcc00","width":"50%","lineHeight":"88rpx","fontSize":"30rpx","fontWeight":"600","height":"88rpx","order":"2"}'>人脸识别登录</button>
				<view class="links" :style='{"padding":"0","margin":"0 0 40rpx","alignItems":"center","flexWrap":"wrap","flexDirection":"column","display":"flex","width":"calc(100% - 0px)","justifyContent":"center","height":"auto","order":"4"}'>
