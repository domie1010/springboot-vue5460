	...
	<view class="content">
		<view :style='{"minHeight":"100vh","padding":"24rpx 0 24rpx","alignItems":"flex-start","flexWrap":"wrap","background":"#f0f8fa","display":"block","width":"100%","position":"relative","height":"auto"}'>
			...
			<view :style='{"padding":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
				<scroll-view scroll-y="true" class="category-two" :style='{"minHeight":"100vh","margin":"0px 0px 0 0","borderRadius":"0px 0 0 0px","background":"#f5f5f5","display":"block","width":"200rpx","height":"100%"}'>
				...
				<!-- 样式2 -->
				<view class="news-box2" :style='{"width":"calc(100% - 200rpx)","padding":"32rpx 24rpx 24rpx","margin":"0 auto","background":"#fff","flex":"1","height":"auto"}'>
					<block v-for="(product,index) in list" :key="index">
					  <view @tap="onDetailTap(product)" v-if="index==0" class="list-item" :style='{"width":"100%","padding":"0","margin":"0 0 20rpx","position":"relative","height":"auto"}'>
						...
						<view :style='{"width":"100%","padding":"20rpx 0","position":"absolute","left":"0","background":"rgba(0,0,0,.3)","bottom":"0"}'>
							<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","whiteSpace":"nowrap","color":"#fff","width":"100%","lineHeight":"1.5","fontSize":"28rpx","textOverflow":"ellipsis","fontWeight":"600"}' class="title ">{{product.title}}</view>
					  ...
					  <view @tap="onDetailTap(product)" v-if="index>0" class="list-item" :style='{"padding":"20rpx 0","borderColor":"#eee","borderWidth":"0 0 2rpx 0","background":"url(http://codegen.caihongy.cn/20240221/8e2fddf1cb4644f6b32d79a4137c914d.png) no-repeat right center","width":"100%","borderStyle":"solid","height":"auto"}'>
						<view :style='{"padding":"0 0px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"calc(100% - 64rpx)","lineHeight":"1.5","fontSize":"28rpx","textOverflow":"ellipsis","fontWeight":"600"}' class="title ">{{product.title}}</view>
		...
		<button :style='{"border":"0","boxShadow":"none","color":"#333","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#ffcc00","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"none","color":"#333","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#ffcc00","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
