<template>
<view class="content">
	<view class="box" :style='{"width":"100%","padding":"24rpx","position":"relative","background":"#f0f8fa","height":"100%"}'>
		<view :style='{"width":"100%","padding":"24rpx","borderRadius":"0","background":"#fff","display":"block","height":"auto"}'>
			...
			<view :style='{"width":"100%","flexWrap":"wrap","justifyContent":"center","display":"flex","height":"auto"}' class="btn">
				<button @tap="update()" class="cu-btn lg" :style='{"border":"0","padding":"0px","margin":"0 20rpx 40rpx","color":"#fff","borderRadius":"60rpx","background":"#ffcc00","width":"40%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}'>保存</button>
